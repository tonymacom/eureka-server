...
public abstract class AbstractInstanceRegistry implements InstanceRegistry {
    ...
    public void setExpectedNumberOfRenewsPerMin(int size){
        this.expectedNumberOfRenewsPerMin = size;
    }
    public void setNumberOfRenewsPerMinThreshold(int size){
        this.numberOfRenewsPerMinThreshold = size;
    }
     ...
     *
     * @see com.netflix.eureka.lease.LeaseManager#register(Object, int, boolean)
     */
    public void register(InstanceInfo registrant, int leaseDuration, boolean isReplication) {
        try {
            ...
            if (existingLease != null && (existingLease.getHolder() != null)) {
                ...
                // The lease does not exist and hence it is a new registrationnumberOfRenewsPerMinThreshold
                ...
                synchronized (lock) {
                    if (this.expectedNumberOfRenewsPerMin > 0) {
                        ...
                        logger.info("expectedNumberOfRenewsPerMin after register is :{}", expectedNumberOfRenewsPerMin);
                        this.numberOfRenewsPerMinThreshold =
                                (int) (this.expectedNumberOfRenewsPerMin * serverConfig.getRenewalPercentThreshold());
                        logger.info("numberOfRenewsPerMinThreshold after register is :{}", numberOfRenewsPerMinThreshold);
                    }
                }
    ...
    public AtomicReference<Boolean> upgrade = new AtomicReference(false);
    ...
    public void evict(long additionalLeaseMs) {
        ...
        if (!isLeaseExpirationEnabled()) {
            ...
            if(upgrade.get()){
                doUpgrade();
                upgrade.compareAndSet(true,false);
            }else{
    ...
    public void doUpgrade(){
        ...
        int registrySize = (int) getLocalRegistrySize();
        int count = registrySize == 0 ? 1: registrySize;
        this.expectedNumberOfRenewsPerMin = count * 2;
        this.numberOfRenewsPerMinThreshold = (int) (expectedNumberOfRenewsPerMin * serverConfig.getRenewalPercentThreshold());
        logger.info("after upgrade expectedNumberOfRenewsPerMin :{}",this.expectedNumberOfRenewsPerMin);
        logger.info("after upgrade numberOfRenewsPerMinThreshold :{}",this.numberOfRenewsPerMinThreshold);
    }
     ...
     *
     * @see com.netflix.discovery.shared.LookupService#getApplication(String)
     */
    @Override
